...
var readingLevelsJ = {
  ...
  "english": {
    ...
    "count": 116014, 
    "composite_community": 265,
    "composite_intellegence": 137.285513534346, 
    "reading_level": 9.041334695331413, 
    "word_count": 97, 
    "min_age": 13
  }
}
...
var readingLevelsW = {
  ...
  "Ruby": {
    ...
    "favorite_count": 1
      ...
      for (x = 0; x < readingLevels.length; x++) {
        if(readingLevels[x].lang != "English") {
      ...
      svg.selectAll(".gc")
          ...
          .style("fill", function(d){ 
            if (d.lang == "Cooking" || d.lang == "English") {
              d3.select(this).attr("class","ne");
              return "#3CB5DE";
            }
            else {
  ...
  $("[name='eng-check']").bootstrapSwitch({
    "size":"small",
    "onSwitchChange":blueTog
  })

  function blueTog() {
    $(".ne").parent().toggle("slow");
  }
...
function parseKey(k) {
  ...
  $.each(readingLevelsW, function(index, value) {
      //rec.lang = value.lang;
      var lang = value[lang];
